...
@interface FMSlashPagingController ()
...
@implementation FMSlashPagingController
...
- (void)setupNavbar {
    ...
    self.navigationItem.title = @"我的砍价";
...
- (NSArray *)pageItems {
    if (! _pageItems) {
        NSString * const classNameVC = @"FMSlashGoodsListController";
        _pageItems = @[
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"全部"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"砍价中"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"待支付"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"砍价成功"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"砍价失败"},
                       ];
    }
    return _pageItems;
}
