...
#import "FMSpellGroupView.h"
#import "FMSpellGroupViewModel.h"

@interface FMSpellGroupController ()

@property (nonatomic, strong) FMSpellGroupView *mainView;

@end

@implementation FMSpellGroupController
...
- (void)fm_addSubviews {
    _mainView = (FMSpellGroupView *)FMSpellGroupView.cv_viewFromNibLoad();
