//
//  FMSpellGroupPagingController.m
//  SeventreesUser
//
...
@interface FMSpellGroupPagingController ()
...
@implementation FMSpellGroupPagingController
...
- (NSArray *)pageItems {
    if (! _pageItems) {
        NSString * const classNameVC = @"FMSpellListController";
        _pageItems = @[
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"全部"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"待付款"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"待成团"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"待收货"},
                       @{kClassNameVCKey : classNameVC, kTitleKey : @"待评论"},
                       ];
    }
    return _pageItems;
}
