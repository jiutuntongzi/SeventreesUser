...
@implementation FMSpellGroupView

@synthesize viewModel = _viewModel;

#pragma mark - Private Functions

- (void)setViewModel:(FMSpellGroupViewModel *)viewModel {
...
- (instancetype)initWithViewModel:(id <FMViewModelProtocol>)viewModel {
    _viewModel = (FMSpellGroupViewModel *)_viewModel;
...
- (FMSpellGroupViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[FMSpellGroupViewModel alloc] init];
    }
    return _viewModel;
}
