    ...
    switch (self.type) {
        case BRStringPickerComponentSingle:
        {
            ...
            if (self.isAutoSelect) {
                if(self.resultBlock) {
                    self.resultBlock(self.selectValue,self.selectIdx);
                }
            }
        }
            break;
        case BRStringPickerComponentMore:
        {
            ...
            if (self.isAutoSelect) {
                if(self.resultBlock) {
                    self.resultBlock([self.selectValueArr copy],self.selectIdx);
                }
            }
        }
            break;
...
- (void)clickRightBtn {
    ...
    if(_resultBlock) {
        if (self.type == BRStringPickerComponentSingle) {
            _resultBlock(self.selectValue,self.selectIdx);
        } else if (self.type == BRStringPickerComponentMore) {
            _resultBlock(self.selectValueArr,self.selectIdx);
        }
    }
}
