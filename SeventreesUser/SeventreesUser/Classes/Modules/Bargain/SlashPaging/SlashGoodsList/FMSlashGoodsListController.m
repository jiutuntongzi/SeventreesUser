...
- (void)fm_addSubviews {
    ...
    PagingView *pagingView = [[PagingView alloc] initWithLimit:10 uriPath:@"" rowHeight:FMSlashGoodsCellHeight params:@{@"userId": @"1059"} requestDataHandler:^(NSDictionary *result) {
